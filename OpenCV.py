    ...
    if motion_detected:
        ...
        if len(x_indices) > 0 and len(y_indices) > 0:
            ...
            if x_min > frame_width // 2:
                ...
                print(f"Filtered Motion detected on right half: Bounding box=(({x_min}, {y_min}), ({x_max}, {y_max}))", flush=True)
            else:
                # 왼쪽에서 감지된 경우 무시되었음을 알림
                print("Motion detected in the left half, ignored.", flush=True)
