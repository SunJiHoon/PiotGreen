디렉터리: tcp_socket_no_wiringPi
담당자: 선지훈

이 디렉터리는 기존 tcp_socket 디렉터리를 변형한 버전입니다. 단, wiringPi 관련 코드가 없습니다. 제어기능이 없으면서 단순히 데이터 통신 테스트 용도입니다.
TCP 소켓 통신을 사용하여 클라이언트와 서버 간의 통신을 구현하는 코드 파일을 포함하고 있습니다.
## 파일 설명
